...
vIMF = sys.argv[5] == 'True' #whether to run in vIMF mode
...
KIRTboxsize = unyt.unyt_quantity(min(100., 100. * 1.8 / 0.7 * scaleFactor), 'kpc') # Scale SKIRT box size akin to COLIBRE gravitational softening length
